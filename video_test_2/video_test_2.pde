...
//https://funprogramming.org/126-A-Processing-abstract-video-player.html
...
void draw() {
  ...
  for(int i=0; i<100; i++) {
    ...
    int loc = y*2*width+x*2;
    println("loc: ", loc);
    println("pixels: ", mov.pixels.length);
  
    int c = mov.pixels[loc];
